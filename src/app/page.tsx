  ...
  return (
    <>
      ...
      <EditorialQuoteBand
        ...
        imageSrc="/images/legacy/photos/session-6dbef3b0.jpg"
      ...
      <section className="relative overflow-hidden py-16 text-white sm:py-20 md:py-28">
        <div className="absolute inset-0 isolate">
          ...
          {/* Mehr Zwischenstufen (color-mix) mindert 8-bit-Banding; weiches Kreuz-Verlauf */}
          <div
          ...
          {/* Feinkorn: bricht harte Farbstufen im Verlauf auf (Monitor/Export) */}
          <div
