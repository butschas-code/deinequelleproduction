...
function WhatsappHeroButton() {
  return (
    ...
    >
      <svg viewBox="0 0 24 24" aria-hidden="true" className="btn-whatsapp-icon">
        <path
          fill="currentColor"
      ...
      <span className="btn-whatsapp-copy">
        <span className="btn-whatsapp-label">
          <span className="btn-whatsapp-kicker">Fragen & Buchung</span>
          {" "}
          direkt per WhatsApp
        </span>
        <span className="btn-whatsapp-phone">{site.phoneIntl}</span>
      </span>
    ...
    >
      <div className="svc-prose-block">
        ...
        {section.logos?.length ? (
          <div className="svc-logo-strip reveal d2" aria-label="Zertifizierungen">
            {section.logos.map((logo) => (
              <img
                key={logo.src}
                src={logo.src}
                alt={logo.alt}
                className={`partner-logo${logo.shape === "square" ? " partner-logo-square" : ""}${
                  logo.shape === "wide" ? " partner-logo-wide" : ""
                }`}
              />
            ))}
          </div>
        ...
        <div className="footer-grid">
          <div className="footer-col brand-col">
            ...
            <div className="footer-partner-logos">
              ...
              />
              <img src="/images/other/css coin.webp" alt="CSS Coins" className="partner-logo" />
            </div>
          </div>
